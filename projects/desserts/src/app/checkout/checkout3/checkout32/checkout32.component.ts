...
@Component({
  selector: 'app-checkout32',
  templateUrl: './checkout32.component.html',
  styleUrls: ['../../../checkout/checkout.css']
})
export class Checkout32Component {
  ...
  public onSubmitCart(): void {
    const body = {
      ...
      postAddress: this.receiveAddress,
  ...
  public onCityChange() {
    ...
    if (selectedCity) {
      ...
      if (!this.availableDistricts.includes(this.receiveBlock)) {
        this.receiveBlock = this.availableDistricts[0];
      }
    } else {
